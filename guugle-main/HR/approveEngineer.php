...
<form action="approveProcess.php" method="post">
    ...
    <button type="submit" name="action" class=" btn btn-primary m-1" value="approve">Approve</button>
    <button type="submit" name="action" class=" btn btn-danger m-1" value="reject">Reject</button>
</form>
<?php
