...
<head>
    ...
    <title>Set Self-Enrollment Period</title>
</head>
<body>
  ...
  <?php
  $courseId = $_POST['selfEnrol'];
  $courseDAO = new CourseDAO();
  $course_obj = $courseDAO->getCourse($courseId);              
  ?>  
  <h1>Set Self-Enrollment Period</h1>
  <form method="get" action="selfEnrollProcess.php" class="m-2">
  <div class="form-group">
      <label for="courseId">Course ID</label>
      <input type="text" id="courseId" name="courseId" value="<?php echo $courseId ?>" class="form-control" >
    </div>
    <div class="form-group">
      <label for="name">Name</label>
      <input type="text" id="name" name="name" class="form-control" value="<?php echo $course_obj->name ?>">
    </div>
    <div class="form-group">
      <label for="date">Self-Enrollment Date</label>
