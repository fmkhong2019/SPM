...
<body>
  ...
  <div class='container' style='margin-top:10%;'>
    <div class='row'>
      <div class='col-md-6'>
        <form method='post' action='server/helper/getQuiz.php'>
          <div class='form-group'>
            <div class="form-row mb-2">
              <div class="col">
                Section <input type="text" class="form-control" value=<?php echo $section; ?> name='sectionId' placeholder="Enter Section" readonly>
              </div>
              <div class="col">
          ...
          <div class='form-group'>
            ...
            <input type="range" class='form-control' value='0' id="time" name="time" oninput="this.nextElementSibling.value = this.value" min="0" max="120">
            <output>0</output>
...
<script>
  ...
  let url = `./server/helper/getQuiz.php?sectionId=${sectionId}&classId=${classId}`;
