                ...
                <table id='details' class='table table-hover table-borderless table-dark'>
                    <thead>
                        ...
                        <tr style="border-bottom: 2px solid orange;">
                            ...
                            <th scope="col">View Materials</th>
        ...
        function getSection() {
            ...
            request.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    <td>${sname}</td>
                    <td>${description}</td>
                    <td><input type = "button" value = "View all materials" id = classId$sectionid = onclick="myFunction(${sectionid}, ${classId})"></button></td>
                    <td><a href="Createquiz.php?sectionId=${sectionid}&classId=${classid}" class='btn btn-primary'>Create Quiz</a></td>
                    ...
                    <td>Final Quiz</td>
                    <td>Final Quiz, Learners are to attain 85% to pass</td>
                    <td>No materials</td>
                    <td><a href="Createquiz.php?sectionId=-1&classId=${classid}" class='btn btn-primary'>Create Quiz</a></td>
            ...
            //request.send();
            request.open("GET", `./server/helper/getTrainerSection.php?classId=${classId}`, true);
            request.send();
        }
