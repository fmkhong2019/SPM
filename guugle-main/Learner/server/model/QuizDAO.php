<?php
    ...
    public function getUpdatedList($sectionId,$classId){
        ...
        while($row = $stmt->fetch()){
            ...
            $result[] = new Quiz( $row['questionId'], $row['sectionId'],$row['classId'],$row['question'],$row['type'],$row['Answer1'],$row['Answer2'],$row['Answer3'],$row['Answer4'],$row['correctAnswer'],$row['duration']);
        }
        $stmt = null;
        $pdo = null;
