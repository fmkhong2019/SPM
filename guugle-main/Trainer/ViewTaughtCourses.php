...
<div class="container">
<h2 style="margin-top:12%;">Courses That You Teach</h2>
<hr>
...
<script>
var url = "../Learner/server/helper/getTaughtClasses.php";
...
request.onreadystatechange = function() {
    ...
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Course Name: ${node.coursename} </h5></h5>
        <p class="card-text ">Course Code: ${node.courseid} <br>
        <a href="./ViewTaughtClasses.php?id=${node.courseid}" class="btn btn-primary">View Classes</a>
      </div>
    </div>
